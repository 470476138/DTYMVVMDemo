...
//  AutoSizeView
//
//  Created by 马佳 on 16/4/1.
//  Copyright © 2016年 马佳. All rights reserved.
//
...
@implementation UIView (hly_animation)
- (void)hly_fadeInWithDuration:(NSTimeInterval)duration
{
    self.hidden = NO;
    self.alpha = 0;
...
- (void)hly_fadeOutWithDuration:(NSTimeInterval)duration
{
    [UIView animateWithDuration:duration animations:^{
        self.alpha = 0;
...
- (void)hly_moveToWithDuration:(NSTimeInterval)duration origin:(CGPoint)origin
{
    [UIView animateWithDuration:duration animations:^{
        self.hly_origin = origin;
    }];
}

- (void)hly_rotationWithDuration:(NSTimeInterval)duration origin:(CGFloat)rotation
{
    [UIView animateWithDuration:duration animations:^{
